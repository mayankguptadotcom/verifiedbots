...
| stract-crawler | Stract | deferred | — | Open-source search engine; trystract.com/webmasters is cited by arcjet as documenting StractBot (UA `StractBot/0.1; open source search engine`). Could NOT verify live this session — trystract.com TLS certificate has expired (fetch failed). Retry once the cert is renewed; distinctive UA and operator look listable. | 2026-07-20 |
| you-crawler | You.com | deferred | — | YouBot AI-search crawler, distinctive UA `YouBot (+http://www.you.com)`, but no operator bot-docs page located: about.you.com/youbot/ 404s and arcjet's only URL is the you.com homepage. Needs a You.com-owned bot page. | 2026-07-20 |
| marginalia-crawler | Marginalia Search | deferred | — | Small independent search engine; arcjet's UA token is the bare hostname `search.marginalia.nu`. about.marginalia-search.com/article/webmaster/ 404s this session; needs an operator page documenting the crawler UA/robots behavior. | 2026-07-20 |
